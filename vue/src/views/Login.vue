<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #1450aa">忆影校园影视交流平台</div>
...
.login-container {
  ...
  align-items: center;
  background-image: url("@/assets/imgs/premium_photo.jpg");
